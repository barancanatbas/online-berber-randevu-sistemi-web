...
<div class="container">
    ...
    İnternet sitemizde verilen tüm servisler Kayrancık Mah. Müezzin İbrahim Cad. No:108 Adapazarı/SAKARYA adresinde kayıtlı ACEGEN Yazılım Reklam Gazetecilik Yayıncılık San. ve Tic. Ltd. Şti. firmamıza aittir ve firmamız tarafından işletilir.
    ...
    Üyelik veya Mağazamız üzerindeki çeşitli form ve anketlerin doldurulması suretiyle üyelerin kendileriyle ilgili bir takım kişisel bilgileri (TC kimlik numaraları, isim soyisim, firma bilgileri, telefon, adres veya e-posta adresleri gibi) Mağazamız tarafından işin doğası gereği toplanmaktadır.
    ...
    Firmamız, alışveriş sitelerimizden alışveriş yapan kredi kartı işlerinde altyapı olarak iyzico firmasını kullanmaktadır. Firmamız Kredi kartı bilgileriniz hiçbir şekilde sistemimizde saklanmamaktadır.
    ...
    Gizlilik politikamız ile ilgili her türlü soru ve önerileriniz için bilgi@berberburada.com adresine email gönderebilirsiniz. Firmamız’a ait aşağıdaki iletişim bilgilerinden ulaşabilirsiniz.
</div>
